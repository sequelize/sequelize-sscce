...
docker compose -p sequelize-postgres-oldest-v7 down --remove-orphans
docker compose -p sequelize-postgres-oldest-v7 up -d

./../../wait-until-healthy.sh sequelize-postgres-oldest-v7

DIALECT=postgres ts-node ../../check-connection.ts

docker exec sequelize-postgres-oldest-v7 \
