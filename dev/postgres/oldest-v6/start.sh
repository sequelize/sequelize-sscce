...
docker compose -p sequelize-postgres-oldest-v6 down --remove-orphans
docker compose -p sequelize-postgres-oldest-v6 up -d

./../../wait-until-healthy.sh sequelize-postgres-oldest-v6

DIALECT=postgres ts-node ../../check-connection.ts

docker exec sequelize-postgres-oldest-v6 \
